...
Quy trình hiện tại thu **MSSV, họ tên tự khai, thời gian server và IP kết nối** trong phiên TA mở. QR và mã nhập tay đổi mỗi 30 giây. Không có bước đăng nhập Google sinh viên hoặc ràng buộc email–MSSV. Đăng nhập captive portal của USTH không được app đọc hay dùng làm xác thực danh tính.

Cùng mạng và họ tên đủ để tạo **bản ghi điểm danh**, chưa tự chứng minh đúng người. Quy trình xác nhận có mặt và cách xử lý ngoại lệ cần do giảng viên thống nhất; app hỗ trợ bằng thông tin đối chiếu và lịch sử TA.
...
| Cùng trình duyệt quét QR mới, đổi tab hoặc mở lại đợt | Trả biên nhận cũ; server chặn MSSV thứ hai trong đợt | Cookie có chữ ký; khóa giữ trong SQLite khi app khởi động lại |
...
**Giới hạn thực tế:** người ở trong cùng mạng vẫn có thể chuyển tiếp QR/mã còn hạn cho nhau. MSSV tự khai, nhiều thiết bị hoặc NAT cũng hạn chế giá trị của cờ IP. QR động không thay kiểm tra thẻ/người tại ghế. HTTP LAN chưa mã hóa. Không quảng bá quy trình này là “không thể cheat”.


**Ranh giới nhận diện:** cookie xác định một hồ sơ trình duyệt, không phải điện thoại hay con người. Đổi trình duyệt, ẩn danh, xóa cookie, đổi IP của host hoặc dùng máy thứ hai có thể tạo nhận diện mới. Không đọc tài khoản Wi-Fi, MAC hay IMEI của điện thoại. Muốn ràng buộc đúng người cần tài khoản/email đã xác thực với MSSV, hoặc mã cá nhân TA phát sau khi kiểm tra thẻ; không cần biết mật khẩu của sinh viên.
